...
export type AgentRunTrigger = "manual" | "on_new_case" | "schedule";
...
export function runDigest(
  ...
  return request<AgentRun>('/api/productions/' + encodeURIComponent(productionId) + '/brief', baseUrl, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' }
  }, fetcher);
}
...
export function runWatch(
  ...
  return request<AgentRun>('/api/productions/' + encodeURIComponent(productionId) + '/watch', baseUrl, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' }
  }, fetcher);
}
...
export function escalateFinding(
  ...
  return request<Finding>('/api/productions/' + encodeURIComponent(productionId) + '/cases/' + encodeURIComponent(caseId) + '/findings/' + encodeURIComponent(findingId) + '/escalate', baseUrl, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify(payload)
  }, fetcher);
...
export function listWorkspaceMembers(
  ...
  return request<WorkspaceMember[]>('/api/workspace/members', baseUrl, { method: 'GET' }, fetcher);
}
...
export function createWorkspaceMember(
  ...
  return request<WorkspaceMember>('/api/workspace/members', baseUrl, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify(payload)
  }, fetcher);
...
export function deleteWorkspaceMember(
  ...
  return request<void>('/api/workspace/members/' + encodeURIComponent(memberId), baseUrl, { method: 'DELETE' }, fetcher);
}
...
export function listOrganizationIssues(
  ...
  return request<OrganizationIssue[]>('/api/workspace/issues', baseUrl, { method: 'GET' }, fetcher);
}
